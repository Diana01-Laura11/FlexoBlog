                ...
                <div class="card mb-6">
                    ...
                    <div class="card-body">
                        <form action="{{ route('galeries.saveGalleries') }}" method="post">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="title" name="title"
                                        ...
                                        value="{{ isset($galeries) ? $galeries->title : '' }}" required>
                                </div>
                            </div>
                            <div class="row mb-6">
                            ...
                            @include('galeries.content-ckeditor')
                            <br><br><br>
                    ...
                    <button class="btn btn-primary" name="openManager" id="BtnimagenPrincipal" type="button">Cargar imagen</button>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-sm-10">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control mb-2 urlimagen" type="text"
                                                name="fotoPrincipal" id="fotoPrincipal"
                                                placeholder="/assets/imagenes-blog/...">
                                            <button class="btn btn-primary" name="openManager" id="BtnfotoPrincipal"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control mb-2 urlimagen" type="text" name="imagen"
                                                id="imagen" placeholder="/assets/imagenes-blog/...">
                                            <button class="btn btn-primary" name="openManager" id="Btnimagen"
                                                type="button">Cargar imagen</button>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control mb-2 urlimagen" type="text" name="banner"
                                                id="banner" placeholder="/assets/imagenes-blog/...">
                                            <button class="btn btn-primary" name="openManager" id="Btnbanner"
                                                type="button">Cargar imagen</button>
                                            <div class="col mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="og_title"
                                                name="ogdata[title]" placeholder="Ingresa el título para el OG">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col mb-3">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-sm-12 d-flex justify-content-center">
                                    ...
                                    <button class="btn btn-success" type="submit">Agregar galeria</button>
