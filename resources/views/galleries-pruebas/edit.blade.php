                ...
                <div class="card mb-6">
                    ...
                    <div class="card-body">
                        <form
                            ...
                            <div class="row mb-6">
                                <label class="col-sm-2 col-form-label" for="title">CONDICION DE PROMOCION</label>
                                <div class="col-sm-10">
                            ...
                            <input type="hidden" name="principal_Image" id="hiddenImageUrl"
                                value="{{ isset($promotionEdit) ? $promotionEdit->principal_Image : '' }}">
                            ...
                            <div class="row mb-6">
                                <label class="col-sm-2 col-form-label" for="microdata_title">MICRODATA TITLE</label>
                                <div class="col-sm-10">
