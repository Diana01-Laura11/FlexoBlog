...
$(document).ready(function() {
    $('#createNewsButton').on('click', function(event) {
        ...
        $.ajax({
            ...
            error: function(xhr) {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
                    text: 'Hubo un problema al crear la noticia Verifica Tus Cammpos Que Esten Completos o No Duplicados.',
                });
