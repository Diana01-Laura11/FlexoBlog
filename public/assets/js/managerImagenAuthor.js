...
document.getElementById('AddImagen').onclick = function () {
    ...
    // Actualiza el campo oculto correspondiente dependiendo de la imagen seleccionada
    const selectedButton = document.getElementsByClassName("selectedButton")[0];
    if (selectedButton) {
        if (selectedButton.id === 'BtnPhoto') {
            console.log('Imagen seleccionada para Autor:', urlValue);
            document.getElementById('hiddenPhotoImageUrl').value = urlValue;  // Imagen del autor
        }
    }
